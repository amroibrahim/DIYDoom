...
# Notes 014 - Solid Wall Heights (Part 1)
...
So, for this notes I will be projecting the walls using a similar technique to that which is used in Wolf3D. Please note that this technique didn't give me output that was identical to that of the original DOOM.  

With that out of the way let's get started!   
As usual, I like to start with the givens, what we know up to this point.  
1. We know the player location X, and Y.  
2. We know how far the player is from the screen 160 units (Notes 011).  
...
Visualize what happened in the last two notes   
