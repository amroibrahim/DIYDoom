...
| Field Size | Data Type | Content                                        |  
|------------|-----------|------------------------------------------------|  
| 0x00       |    byte   | Offset (Y Offset) terminated with 0xFF         |  
| 0x01       |    byte   | Length of data                                 |  
| 0x02       |    byte   | Padding byte (not used)                        |  
| 0x03-0x??  |   Length  | Pixel Data, each byte is an index into palette |  
| 0x??+1     |    byte   | Padding byte (not used)                        |  
